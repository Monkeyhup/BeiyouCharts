...
<head>
	...
	<script type="text/javascript" src="/base2.1/http/lib/Echarts/echarts-liquidfill.js"></script>
...
//				[ '.tpl', '.tpl?t=' + new Date().getTime() ],
	...
	seajs.use('js/chart.echarts.edit',function(obj){
        obj.init(IS_CAN_INIT);
    });
	seajs.use('/tool2.1/http/js/navBarEditJSP',function(obj){
		obj.into();
	});
</script>
</html>
