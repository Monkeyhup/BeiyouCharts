    	...
    	<div class="panel-body">
		    <div class="input-group">
		    	<span class="input-group-addon" style="width:auto;">
		      	...
		      	<input id="chart-bar-color-select-0" type="color" class="form-control" style="width:45px;" value="#c23531" />
		    </div><!-- /input-group -->
		    <br/>
		    <div class="input-group">
		    	<span class="input-group-addon" style="width:auto;">
		      	...
		      	<span class="input-group-addon" style="width:auto;">
		       		<input id="chart-bar-top-border-radius-range" type="range" value="8" max="20" min="0">
		       	</span>
		      	<input id="chart-bar-top-border-radius-text" type="text" class="form-control" disabled="disabled" style="width:45px;" value="8" />
		    	<span class="input-group-addon" style="width:auto;">
		        	px
		      	</span>
		    </div><!-- /input-group -->
            ...
            <div class="input-group">
                ...
                <span class="input-group-addon" style="width:auto;">
                    <input id="chart-bar-width-range" type="range" value="67"  max="150" min="0">
                </span>
                <input id="chart-bar-width-text" type="text" class="form-control" disabled="disabled" style="width:50px;" value="67" />
                <span class="input-group-addon" style="width:auto;">
                    px
                </span>
            </div><!-- /input-group -->
