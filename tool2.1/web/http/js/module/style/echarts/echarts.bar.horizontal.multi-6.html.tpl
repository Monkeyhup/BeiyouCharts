    	...
    	<div class="panel-body">
    		<div class="input-group">
		    	<span class="input-group-addon" style="width:auto;">
		      	...
		      	<input id="chart1-bar-color-select" type="color" class="form-control" style="width:45px;" value="#FFD700" />
		      	<input id="chart2-bar-color-select" type="color" class="form-control" style="width:45px;" value="#27408B" />
		    </div><!-- /input-group -->
		    <br/>
    	</div>
    </div>
