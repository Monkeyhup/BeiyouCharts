    	...
    	<div class="panel-body">
		    <div class="input-group">
		    	<span class="input-group-addon" style="width:auto;">
		      	...
		      	<input id="chart-bar-color-select-0" type="color" class="form-control" style="width:45px;" value="#008B8B" />
		    </div><!-- /input-group -->
		    <br/>
            <div class="input-group pull-left">
                ...
                <input id="chart-backgroundColor-select" type="color" class="form-control" style="width:45px;" value="#4F4F4F" />
            </div><!-- /input-group -->
            ...
            <div class="input-group">
                ...
                <span class="input-group-addon" style="width:auto;">
                    <input id="chart-bar-width-range" type="range" value="92"  max="150" min="0">
                </span>
                <input id="chart-bar-width-text" type="text" class="form-control" disabled="disabled" style="width:50px;" value="92" />
                <span class="input-group-addon" style="width:auto;">
                    px
                </span>
            </div><!-- /input-group -->
