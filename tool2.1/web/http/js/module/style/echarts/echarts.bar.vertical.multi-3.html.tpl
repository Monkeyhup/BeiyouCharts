    	...
    	<div class="panel-body">
		    ...
		    <div class="input-group">
		    	<span class="input-group-addon" style="width:auto;">
		      	...
		      	<span class="input-group-addon" style="width:auto;">
		       		<input id="chart-bar-top-border-radius-range" type="range" value="5"  max="20" min="0">
		       	</span>
		      	<input id="chart-bar-top-border-radius-text" type="text" class="form-control" disabled="disabled" style="width:45px;" value="5" />
		      	<span class="input-group-addon" style="width:auto;">
		        	px
		      	</span>
		    </div><!-- /input-group -->
		    ...
		    <div class="input-group">
		    	<span class="input-group-addon" style="width:auto;">
		      	...
		      	<span class="input-group-addon" style="width:auto;">
		       		<input id="chart-bar-bottom-border-radius-range" type="range" value="5"  max="20" min="0">
		       	</span>
		      	<input id="chart-bar-bottom-border-radius-text" type="text" class="form-control" disabled="disabled" style="width:45px;" value="5" />
		      	<span class="input-group-addon" style="width:auto;">
		        	px
		      	</span>
		    </div><!-- /input-group -->
