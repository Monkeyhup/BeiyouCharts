...
public class DHTMLXTree {
	...
	public String toString() {
		...
		if (this.isOpen) {
			re += DHTMLXTreeHelper.open;
		}
		if (this.noCheckbox) {
			re += DHTMLXTreeHelper.nock;
		}
		if (this.isChecked) {
			re += DHTMLXTreeHelper.checked;
		}
		if (this.attrs != null) {
		...
		if (this.userdata != null) {
			for (String key : this.userdata.keySet()) {
				re += "<userdata name=\"" + key + "\">"
						+ this.userdata.get(key) + "</userdata>";
			}
		}
		if (this.childs != null) {
